...
public class Gripper {
     ...
     */
    public void setMotorSpeed(double speed) {myMotor.setPower(speed);}
    public void setGripperOpen() {myServo.setPosition(1);}
   public void setGripperClose() {myServo.setPosition(0.87); }
}